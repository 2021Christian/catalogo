    ...
    <div class="alert p-4 col-8 mx-auto shadow">
        ...
        @csrf
            ...
            <div class="input-group mb-4">
                ...
                <input type="number" name="prdPrecio" value="{{ old('prdPrecio', $Producto->prdPrecio)}}"
            ...
            <div class="form-group mb-4">
                ...
                <select class="form-select" name="idMarca" id="idMarca">
                    ...
                    @foreach ($marcas as $marca)
                        ...
                        <option value="{{ $marca->idMarca }}" {{ ( $marca->idMarca == old('idMarca', $Producto->idMarca) )?"selected":"" }}>
                            {{ $marca->mkNombre }}
                        </option>
            ...
            <div class="form-group mb-4">
                ...
                <select class="form-select" name="idCategoria" id="idCategoria">
                    ...
                    @foreach ($categorias as $categoria)
                        ...
                        <option value="{{ $categoria->idCategoria }}" {{ ( $categoria->idCategoria == old('idCategoria', $Producto->idCategoria) )?"selected":"" }}>
                            {{ $categoria->catNombre }}
                        </option>
